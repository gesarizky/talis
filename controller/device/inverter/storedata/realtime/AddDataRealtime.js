import RealtimeInverter from "@/model/realtime/inverter/inverter";

const StoreDataRealtimeInverter = async (datainverter) => {
  ...
  try {
    const [dataRealtimeDbInverter, created] = await RealtimeInverter.upsert({
...
export default StoreDataRealtimeInverter;
