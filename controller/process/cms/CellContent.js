...
const CellContent = (frame_name, dataVcell, modelParam) => {
    ...
    const hasilContent = dataVcell.map((value, i) => {
        ...
        const rangeContent = configModelParam.maximumCellVoltage - configModelParam.minimumCellVoltage;

        const extractValue = value>configModelParam.minimumCellVoltage ? value - configModelParam.minimumCellVoltage:0;
